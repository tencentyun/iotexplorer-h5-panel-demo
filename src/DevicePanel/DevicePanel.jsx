...
export function DevicePanel() {
  ...
  const [asrPanelInfo, setAsrPanelInfo] = useState({
    visible: false,
    templateId: "",
  });
  ...
  return (
    <div>
      ...
      >
        ...
        {asrPanelInfo.visible &&
          <AsrPanelControl
            visible={true}
            templateConfig={state.templateMap[asrPanelInfo.templateId]}
            onClose={() => setAsrPanelInfo({ visible: false, templateId: "" })}
          />
        }
      </div>
    </div>
